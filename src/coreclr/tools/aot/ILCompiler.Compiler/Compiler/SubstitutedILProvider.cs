        ...
        public override MethodIL GetMethodIL(MethodDesc method)
        {
            ...
            if (result != null)
            {
                ...
                else
                {
                    ...
                    result = GetMethodILWithInlinedSubstitutions2(result);
                }
            }
            return result;
            ...
            while (reader.HasNext)
            {
                ...
                switch (state)
                {
                    ...
                    case 2 when opcode == ILOpcode.newobj:
                    {
                        ...
                        if (type is { Namespace: "System", Name: "ReadOnlySpan`1" } && type.Instantiation[0].IsWellKnownType(WellKnownType.Byte))
                        {
                            state = 3;
                            break;
                        }
